...
#import "Employe_Menu_ViewController.h"
...
@interface Employe_Menu_ViewController ()
{
...
@implementation Employe_Menu_ViewController
...
//{
//    UpdateProfile_Employee_ViewController *vc = [self.storyboard instantiateViewControllerWithIdentifier:@"UpdateProfile_Employee_ViewController"];
//    [self.navigationController pushViewController:vc animated:YES];
//    
//}
//- (IBAction)FAQsBtn:(id)sender
//{
//    Employee_FAQs_ViewController *vc = [self.storyboard instantiateViewControllerWithIdentifier:@"Employee_FAQs_ViewController"];
//    [self.navigationController pushViewController:vc animated:YES];
//}
...
{
    email_news = _email_newsLetter.text;
    
   if ([[email_news stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]] isEqualToString: @""])
    {
        [self.view makeToast:@"Email should not be blank!"];
    }
    else if (![AppMethod stringMatchedREGEX:email_news :REGEX_EMAIL_EXPRESS])
    {
    ...
    {
    setdic = [[NSMutableDictionary alloc]init];
    [setdic setObject:email_news forKey:@"email"];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        Employee_ViewController *photoController = (Employee_ViewController*)segue.destinationViewController;
