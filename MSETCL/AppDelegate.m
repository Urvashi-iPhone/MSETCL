...
fetchCompletionHandler:(void (^)(UIBackgroundFetchResult))completionHandler {
    ...
    // Print full message.
    NSLog(@"userInfo:%@", [[userInfo valueForKey:@"notification"] valueForKey:@"body"]);
...
- (void)applicationReceivedRemoteMessage:(FIRMessagingRemoteMessage *)remoteMessage {
    // Print full message
    NSLog(@"infoo%@", [remoteMessage appData]);
    UILocalNotification *localNotification = [[UILocalNotification alloc] init];
    localNotification.userInfo = [remoteMessage appData];
    localNotification.soundName = UILocalNotificationDefaultSoundName;
    localNotification.alertBody = [[[remoteMessage appData] valueForKey:@"notification"] valueForKey:@"body"];
    localNotification.fireDate = [NSDate date];
    [[UIApplication sharedApplication] scheduleLocalNotification:localNotification];
}
#endif
